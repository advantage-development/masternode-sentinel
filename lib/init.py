...
# def has_dash_conf():
def has_advantage_conf():
    import config
    import io

    # valid_dash_conf = False
    valid_advantage_conf = False

    # ensure dash_conf exists & readable
    # ensure advantage_conf exists & readable
    #
    ...
    try:
        ...
        f = io.open(config.advantage_conf)
        # valid_dash_conf = True
        valid_advantage_conf = True
    except IOError as e:
        print(e)

    # return valid_dash_conf
    return valid_advantage_conf
